  ...
  if (nextCommand >=0) {
    ...
    switch(currentPage) {
      case 0: // menu page 0 (1 of 2)
       switch(nextCommand) {
        case 4:
          MIDI.sendControlChange(snapShots,snapShot1,midiChannel); // snapshot midiChannel
          break;
        case 3:
          MIDI.sendControlChange(snapShots,snapShot2,1); // snapshot 2
          break;
        case 2:
          MIDI.sendControlChange(snapShots,snapShot3,1); // snapshot 3
          break;
        case 1:
          MIDI.sendControlChange(51,ccOff,1); //FS3
          break;
        case 0:
          MIDI.sendControlChange(52,ccOff,1); // FS4
          break;
        case 5:
          MIDI.sendControlChange(60,ccOn,1); //looper record
          break;
        case 6:
          MIDI.sendControlChange(61,ccOn,1); // looper play
          break;        
        case 7:
          MIDI.sendControlChange(62,ccOn,1); //looper play once
          break;
        case 8:
          MIDI.sendControlChange(60,ccOff,1); //looper overdub
          break;    
        case 9:
          MIDI.sendControlChange(63,ccOn,1); // looper undo/redo
          break;   
        case 10:
          MIDI.sendControlChange(71,ccOff,1); // stomp mode
          break;
        case 11:
        ...
        case 12:
          ...
          break;
        case 13:
          MIDI.sendControlChange(53,ccOff,1); // FS5
          break;
        case 14:
        ...
        case 17:
          MIDI.sendControlChange(61,ccOff,1); // looper stop
        case 18:
          changePageUp();
        case 19:
          changePageDown();
